...
public class SqlBaseLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "ADD", "ADMIN", "AFTER", "ALL", "ALTER", 
			"ANALYZE", "AND", "ANY", "ARRAY", "AS", "ASC", "AT", "AUTHORIZATION", 
			"BERNOULLI", "BETWEEN", "BY", "CALL", "CASCADE", "CASE", "CAST", "CATALOGS", 
			"COLLATE", "COLUMN", "COLUMNS", "COMMENT", "COMMIT", "COMMITTED", "CONSTRAINT", 
			"COUNT", "CREATE", "CROSS", "CUBE", "CURRENT", "CURRENT_CATALOG", "CURRENT_DATE", 
			"CURRENT_PATH", "CURRENT_ROLE", "CURRENT_SCHEMA", "CURRENT_TIME", "CURRENT_TIMESTAMP", 
			"CURRENT_USER", "CURSOR", "DATA", "DATE", "DAY", "DEALLOCATE", "DECLARE", 
			"DEFAULT", "DEFINER", "DELETE", "DENY", "DESC", "DESCRIBE", "DEFINE", 
			"DISTINCT", "DISTRIBUTED", "DOUBLE", "DROP", "ELSE", "EMPTY", "END", 
			"EPOCH", "ERROR", "ESCAPE", "EXCEPT", "EXCLUDING", "EXECUTE", "EXISTS", 
			...
			"IMPERSONATE", "IN", "INCLUDING", "INITIAL", "INNER", "INPUT", "INSERT", 
			"INTERSECT", "INTERVAL", "INTO", "INVOKER", "IO", "IS", "ISOLATION", 
			"JOIN", "JSON", "LAST", "LATERAL", "LEFT", "LEVEL", "LIKE", "LIMIT", 
			...
			"OFFSET", "OMIT", "OF", "ON", "ONE", "ONLY", "OPERATOR", "OPTION", "OR", 
			...
			"SEEK", "SELECT", "SERIALIZABLE", "SESSION", "SESSION_USER", "SET", "SETS", 
			...
			"ASTERISK", "SLASH", "PERCENT", "CONCAT", "QUESTION_MARK", "REGEX_MATCH", 
